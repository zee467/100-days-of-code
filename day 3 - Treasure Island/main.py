...
if first_direction == "left":
    instruction = input('You come to a lake. There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" to swim across.\n').lower()
    if instruction == "wait":
        ...
        if color == "blue":
            ...
            print("You chose a color that doesn't exist. Game Over.")
    else:
